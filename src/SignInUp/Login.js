...
const Login = () => {
    ...
    return (
        <div className='lg:w-1/3 w-9/12  shadow-xl mx-auto  mt-4 bg-slate-300 lg:p-14  lg:pb-5 p-8 mb-8'>
            <div>
                <p className='text-center text-3xl font-semibold mb-5'>Login Now</p>
            </div>
            <form onSubmit={handleSubmit(formHandler)} >
                ...
                <div>
                    <button type="submit" disabled={processing} className='btn btn-outline mt-8 w-full'>Login</button>
                </div>
            </form>
